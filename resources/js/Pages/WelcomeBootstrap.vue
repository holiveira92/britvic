  ...
  <div id="app_test">
    <b-container class="p-5">
      ...
      <section class="mb-4">
        ...
        <b-row>
          <b-col class="mb-2" md="3" v-for="(color, index) in themeColors" :key="index">
            <code>.{{ color }}</code>
      ...
      <section class="mb-4">
        ...
        <button type="button" class="btn btn-block btn-primary" @click="modalShow = !modalShow">
          Abrir modal de demostração
        </button>
        ...
        <b-modal
          ...
          v-model="modalShow"
          ok-title="Da hora!"
          class="text-dark w-50 float-left">
            Olá mundo! <a href="https://bootstrap-vue.js.org/docs/components/modal">Veja como me usar</a>.
        </b-modal>
      </section>
...
<script>
import { BModal, CardPlugin, BAlert, BRow, BCol, VBScrollspyPlugin } from 'bootstrap-vue'
